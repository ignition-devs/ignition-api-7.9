...
def modifyTranslation(
    ...
    locale="es_MX",  # type: Optional[String]
):
    # type: (...) -> None
...
def retarget(
    ...
    gatewayAddress=None,  # type: Optional[String]
    params=None,  # type: Optional[Dict[String, Any]]
    startupWindows=None,  # type: Optional[List[String]]
):
    # type: (...) -> None
    ...
    Args:
        projectName: The name of the project to retarget to.
        gatewayAddress: The address of the Gateway that the project
            resides on. If omitted, the current Gateway will be used.
            Format is: "host:httpPort:sslPort/main". Optional.
        ...
        startupWindows: A list of window paths to use as the startup
            windows. If omitted, the project's normal startup windows
            will be opened. If specified, the project's normal startup
            windows will be ignored, and this list will be used instead.
            Optional.
    """
...
def translate(
    term,  # type: String
    locale=None,  # type: Optional[String]
